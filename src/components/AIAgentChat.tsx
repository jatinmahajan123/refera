...
const AIAgentChat = () => {
  const [messages, setMessages] = useState<Message[]>([
    ...
    {
      id: '2',
      content: 'Hey, I want to create a new referral campaign, but I\'d like some help from AI to make sure it\'s set up correctly and performs well. Can you guide me through it?',
      sender: 'user',
      timestamp: new Date(),
    },
    {
      id: '3',
      content: 'Absolutely! I\'ll help you create a high-converting referral campaign step by step. Let\'s start by defining your main objective. What\'s the primary goal of this campaign?',
      sender: 'ai',
      timestamp: new Date(),
    },
    {
    ...
    {
      id: '5',
      content: 'That\'s a great goal! Referral campaigns work best when there\'s a strong incentive. What kind of reward would you like to offer referrers?',
      sender: 'ai',
      timestamp: new Date(),
    },
    {
