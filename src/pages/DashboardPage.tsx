      ...
      case 0:
        return (
          <form className="grid grid-cols-2 gap-6 bg-white p-8 rounded-xl shadow-sm w-full">
            ...
            <div>
              <label className="text-sm font-medium mb-1 block">Business Phone No.</label>
              <Input />
            </div>
            <div>
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="a">Saas/Software</SelectItem>
                  <SelectItem value="b">Fitness & Wellness</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
        ...
        return (
          <form className="bg-white p-8 rounded-xl shadow-sm w-full space-y-10">
            ...
            <div className="flex justify-end">
              <Button className="bg-blue-500 text-white px-8 hover:bg-blue-600">
                Launch
              </Button>
            </div>
          </form>
